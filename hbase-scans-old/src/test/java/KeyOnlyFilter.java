...
/**
 * Clone of {@link org.apache.hadoop.hbase.filter.KeyOnlyFilter}
...
public class KeyOnlyFilter extends FilterBase {
    ...
    public ReturnCode filterKeyValue(Cell ignored) throws IOException {
        System.out.println("***************");
        System.out.println("Discovered rows keys in filter: " + Bytes.toStringBinary(CellUtil.cloneRow(ignored)));
        System.out.println("***************");
